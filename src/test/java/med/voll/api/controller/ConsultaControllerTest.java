...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver cod: http 400 quando informacoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver cod: http 200 quando informacoes estao validas")
    @WithMockUser
